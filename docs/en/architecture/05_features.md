...
> - **Never edit `platform/shell/app_shell/lib/src/navigation/app_router.dart`** to add your routes, and never edit `root_app.dart` to add a localization delegate. Both are assembled from DI contributions.
