...
/// Supplying the boot splash screen to the app shell via `IAppSplashScreen`.
///
/// To remove it and everything that travels with it:
///
/// ```sh
/// dart tools/sample_cleanup/remove_sample.dart splash            # preview
/// dart tools/sample_cleanup/remove_sample.dart splash --apply    # do it
/// ```
///
