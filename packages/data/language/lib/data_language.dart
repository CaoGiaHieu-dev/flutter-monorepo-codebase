...
/// A minimal repository implementation over package-owned storage.
///
/// To remove it and everything that travels with it:
///
/// ```sh
/// dart tools/sample_cleanup/remove_sample.dart language            # preview
/// dart tools/sample_cleanup/remove_sample.dart language --apply    # do it
/// ```
///
